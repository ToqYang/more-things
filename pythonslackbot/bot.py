...
SCHEDULED_MESSAGES = [
    {'text': 'First message', 'post_at': (
        datetime.now() + timedelta(seconds=20)).timestamp(), 'channel': 'C025ZHY5Z17'},
    {'text': 'Second Message!', 'post_at': (
        datetime.now() + timedelta(seconds=30)).timestamp(), 'channel': 'C025ZHY5Z17'}
]
...
if __name__ == "__main__":
    ...
    ids = list_scheduled_messages('C025ZHY5Z17')
    delete_scheduled_messages(ids, 'C025ZHY5Z17')
    app.run(debug=True)